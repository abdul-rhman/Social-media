...
export default function AddPost() {
  ...
  return (
    <>
      <div className='my-4 bg-slate-100 shadow-md shadow-sky-100 shadow-blur  w-full  md:w-[80%] lg:w-[60%] mx-auto rounded-xl'>
        <form onSubmit={handleSubmit(handleAddPost)} className=" p-6 mx-auto">
          <div className="relative z-0 w-full mb-2 group">
            ...
            {image && <div className='mb-4'>
              <img className='max-h-[50vh] w-full object-contain' src={URL.createObjectURL(image)} alt="" />  
            </div>}
          <div className='flex justify-between items-center px-4'>
            ...
            <button type="submit" disabled={isLoading}  className="ms-auto cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{isLoading?<i className='fas fa-spinner fa-spin'></i>:'Post'}</button>
          </div>
        </form>
      </div>
    </>
