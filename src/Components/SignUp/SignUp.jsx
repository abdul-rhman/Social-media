    ...
    <form onSubmit={handleSubmit(handleRegister)} className="max-w-md mx-auto my-5">
      ...
      <div className="flex item-center gap-4 mb-2">
          <div className="flex items-center">
            <input id="male" type="radio" value="male" defaultValue  {...register('gender')}  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
            <label htmlFor="male" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Male</label>
          </div>
          <div className="flex items-center">
            <input defaultChecked id="female" value="female" type="radio"  {...register('gender')} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
