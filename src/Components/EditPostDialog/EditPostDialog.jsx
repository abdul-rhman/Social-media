          ...
          <form onSubmit={handleSubmit(handleUpdatePost)} className=" p-6 mx-auto">
            ...
            <div className='flex justify-between items-center px-4'>
              ...
              <div className='ms-auto'>
                ...
                <button type="button" disabled={isLoading}  className="ms-2 cursor-pointer text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800" onClick={closeDialog}>cancel</button>
              </div>
            </div>
          </form>
        </div>
